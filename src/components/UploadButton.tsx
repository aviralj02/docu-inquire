...
const UploadDropzone = () => {
  ...
  // Once file is uploaded to uploadthing, the getFile procedure will return the file which means file is successfully uploaded
  ...
  return (
    <Dropzone multiple={false} onDrop={onDrop}>
      {({ getRootProps, getInputProps, acceptedFiles }) => (
        <div
          {...getRootProps()}
          className="border h-64 m-4 border-dashed border-gray-300 a rounded-lg"
        >
